    ...
    <div class="row">
        <div class="card">
            <div class="card-body text-center">
                ...
                <h3 class="text-center pb-5">Bienvenue « <?=var_dump($account); $account['firstname'] . '' . $account['lastname'] ?> »</h3>
                ...
                <div class="mt-5">
                    <a class="btn btn-danger d-block full" href="/API_test/logout">Déconnexion</a>
                </div>
            </div>
        </div>
    </div>
